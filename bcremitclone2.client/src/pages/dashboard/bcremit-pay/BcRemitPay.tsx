...
function BcRemitPay() {
  return (
    <div className="px-8">
      ...
      <section className="w-full mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[repeat(4,minmax(0,350px))] auto-rows-[11rem] md:auto-rows-[15rem] place-content-start gap-10">
